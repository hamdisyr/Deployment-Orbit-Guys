...
<div class="panel-heading">
	...
	<tr>
	<td><div align="center">
	<h3><label>RANGKAYO BASA GUEST HOUSE </label></h3>
	<label>Komplek Cendana Andalas Blok. A4, Andalas, Kec. Padang Tim., Kota Padang, Sumatera Barat 25126</label>
	<label>Kota Padang, Sumatera Barat 25115</label> 
	<label>Telp : (0751) 891188</label> 
	<label>Email : info@rangkayobasaguesthouse.com</label>
