<div class="site-blocks-cover overlay" style="background-image: url(images/rangkayo.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="p-4 mb-3 bg-white">
					...
					<p class="mb-4">Komplek Cendana Andalas Blok. A4, Andalas, Kec. Padang Tim., Kota Padang, Sumatera Barat 25126</p>
					<p class="mb-0 font-weight-bold">Phone</p>
					<p class="mb-4"><a href="#">(0751) 891188</a></p>
					<p class="mb-0 font-weight-bold">Email Address</p>
					<p class="mb-0"><a href="#">info@rangkayobasaguesthouse.com</a></p>
				</div>
