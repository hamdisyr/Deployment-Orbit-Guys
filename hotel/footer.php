      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <p>Komplek Cendana Andalas Blok. A4, Andalas, Kec. Padang Tim., Kota Padang, Sumatera Barat 25126</p>
            ...
            <p>info@rangkayobasaguesthouse.com</p>
          </div>
          <div class="col-md-4">
            <div class="row">
              <div class="col-md-6">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy; <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All Rights Reserved | Rangkayo basa Guest House <i class="icon-heart text-primary" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Kelompok 3</a> 
