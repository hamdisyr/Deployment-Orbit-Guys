    ...
    <div class="site-navbar bg-black">
      <div class="py-1">
        <div class="row align-items-center">
          <div class="col-2">
            <h2 class="mb-0 site-logo"><a href="index.php"><img src="images/logo1.JPG" width="150" height="75"></a></h2>
          </div>
          <div class="col-10">
              ...
              <div class="container">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children <?php $aktif = ($_GET['page']=='kamar') ? 'active' : ''; echo $aktif; ?>">
			        ...
			        <li class="<?php $aktif = ($_GET['page']=='contact') ? 'active' : ''; echo $aktif; ?>"><a href="?page=contact">Contact Us</a></li>
              <?php 
