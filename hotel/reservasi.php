        ...
        <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
          <div class="row">
            <div class="col-md-10 ml-auto contact-info">
              <p><span style="font-size: 30px;" class="d-block"><strong>ALAMAT</strong>:</span> <span style="font-size: 35px;" class="text-black"> Komplek Cendana Andalas Blok. A4, Andalas, Kec. Padang Tim., Kota Padang, Sumatera Barat 25126</span></p>
              ...
              <p><span style="font-size: 30px;" class="d-block"><strong>EMAIL</strong>:</span> <span style="font-size: 35px;" class="text-black"> info@rangkayobasaguesthouse.com</span></p>
            </div>
          </div>
        </div>
      </div>
